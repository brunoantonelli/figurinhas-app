    ...
    <div class="Box-body-bodies">
      ...
      <div class="Box-pu-geral-info">
        <div className="Box-mi-root">
          ...
          <input v-if="isEditing" className="Input-mi" id="i-name" name="f-name" type="text" value='Editar nome' />
        </div>
        <div className="Box-mi-root">
          <div className="Box-mi-title">
          ...
          <input v-if="isEditing" className="Input-mi" id="i-email" name="email" type="text" value='Editar email' />
        </div>
        <div className="Box-mi-root">
          <div className="Box-mi-title">
          ...
          <input v-if="isEditing" className="Input-mi" id="i-telefone" name="phone" type="tel"
            value='Editar telefone' />
        </div>
        <div className="Box-mi-root">
          <button class="Button-pu-pass" v-if="isEditing">
            MUDAR SENHA
          </button>
        </div>
      </div>
      ...
      <div class="Box-pu-localization">
        <div className="Box-mi-root">
          ...
          <input v-if="isEditing" className="Input-mi" id="i-city" name="city" type="text" value='Editar cidade' />
        </div>
        <div className="Box-mi-root">
          <div className="Box-mi-title">
            <span className="Span-mi-title"> BAIRRO </span>
          </div>
          <span className="Span-bm-info" v-if="!isEditing"> {{ district }} </span>
          <input v-if="isEditing" className="Input-mi" id="i-district" name="district" type="text"
            value='Editar bairro' />
        </div>
        <div className="Box-mi-root">
          <div className="Box-mi-title">
          ...
          <input v-if="isEditing" className="Input-mi" id="i-place" name="place" type="text" value='Editar rua' />
        </div>
      </div>
      <button class="Button-pu-save" @click.prevent='changeMode'>
        EDITAR
      </button>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      name: '',
      email: '',
      phone: 'Edite seu perfil para adicionar um telefone',
      city: '',
      district: '',
      place: '',
    };
